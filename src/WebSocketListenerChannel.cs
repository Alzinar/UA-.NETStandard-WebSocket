...
namespace Opc.Ua.Bindings
{
    ...
    internal class WebSocketListenerChannel : UaSCUaBinaryChannel
    {
        ...
        /// </summary>
        protected WebSocketReportAuditCertificateEventHandler ReportAuditCertificateEvent { get; private set; }
        ...
        public WebSocketListenerChannel(
            ...
            : base(
                ...
                telemetry)
        {
            m_logger = telemetry.CreateLogger<WebSocketListenerChannel>();
            Listener = listener;
        }
        ...
        /// Sets the callback used to raise channel audit events.
        /// </summary>
        public void SetReportCertificateAuditCallback(WebSocketReportAuditCertificateEventHandler callback)
        {
            lock (DataLock)
            {
    ...
    /// Used to report an open secure channel audit event.
    /// </summary>
    public delegate void WebSocketReportAuditCertificateEventHandler(
        X509Certificate2 clientCertificate,
        Exception exception);
}